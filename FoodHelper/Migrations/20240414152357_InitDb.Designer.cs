...
namespace FoodHelper.Migrations
{
    ...
    [Migration("20240414152357_InitDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodHelper.Models.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FoodHelper.Models.Food", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FoodHelper.Models.Meal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FoodHelper.Models.MealFood", b =>
                {
            ...
            modelBuilder.Entity("FoodHelper.Models.User", b =>
                {
            ...
            modelBuilder.Entity("FoodHelper.Models.Food", b =>
                {
                    b.HasOne("FoodHelper.Models.Category", "Category")
                        .WithMany("Foods")
                        .HasForeignKey("CategoryId");

                    b.HasOne("FoodHelper.Models.User", "User")
                        .WithMany("Foods")
            ...
            modelBuilder.Entity("FoodHelper.Models.MealFood", b =>
                {
                    b.HasOne("FoodHelper.Models.Food", "Food")
                        .WithMany("MealFoods")
                        .HasForeignKey("FoodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodHelper.Models.Meal", "Meal")
                        .WithMany("MealFoods")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FoodHelper.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
